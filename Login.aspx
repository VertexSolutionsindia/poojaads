  ...
  <br />
   <br />
    ...
    <br />
     ...
     <div class="row">
     <img src="Admin/images/Pooja Add.png" align="middle" width="200px" height="auto" style="margin-left:550px;"/>
     
     </div>
    <div class="b" style=" margin-top:100px" >
      ...
      <table>
      <tr>
      <td><span style="font-weight:bold;color:Black">Email</span><span class="star">*</span></td>
       </tr>
      <tr>
      ...
      <tr>
      <td><span style="font-weight:bold;color:black">Password</span><span class="star">*</span></td>
      </tr>
      <tr>
      <td>   
       ...
       <p style="text-align:right;margin-right:50px; text-decoration:none;"><a style="text-decoration:none;  color: #656565;" href="">  
           <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click1"><span style="color:Blue">Forgot password?</span></asp:LinkButton></a></p>
    ...
    <p><small>©2014 Pooja Advertising, All Rights Reserved.</small></p>
    </div>
    </form>
</body>
</html>
