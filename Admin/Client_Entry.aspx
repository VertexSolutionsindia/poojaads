<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_Entry.aspx.cs" Inherits="Admin_Customer_Wholesale" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <br /><h2>Enter Client Details Here</h2>
  <hr />
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Clent ID : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                  ...
                                  <div class="form-group"><label class="col-lg-3 control-label">Mail Id : </label>
 ...
 <asp:Button ID="Button2" runat="server" class="btn-primary2" Width="70px" Height="30px"  Text="Clear" onclick="Button2_Click" 
  ...
  <div class="row">
   ...
   <div class="col-md-3"><h3>Customer Name : </h3></div>
   <div class="col-sm-8"><asp:DropDownList ID="DropDownList2" 
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <Columns>
        <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Client ID" DataField="Client_Code"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Client Name" DataField="Client_Name" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Address" DataField="Client_Add"  >
              <HeaderStyle CssClass="red" />
           </asp:BoundField>
              <asp:BoundField HeaderText="Mobile No" DataField="Mobile_No"  >
               <HeaderStyle CssClass="red" />
           </asp:BoundField>
               <asp:BoundField HeaderText="Mail Id" DataField="Mail_Id"  >
               <HeaderStyle CssClass="red" />
           </asp:BoundField>
  ...
  <br />  <asp:Button ID="Button14" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox" OnClientClick="return validate1()" onclick="Button14_Click"/>
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" Text="Client Code" class="col-lg-3 control-label" width="200px"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text="" ></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label30" runat="server" Text="Clent Name" class="col-lg-3 control-label" width="200px"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox16" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
      <tr>
        <td>
            <asp:Label ID="Label2" runat="server" Text="Client Address" class="col-lg-3 control-label" width="200px"></asp:Label></td>
        <td>
        ...
        <tr>
        <td>
            <asp:Label ID="Label8" runat="server" Text="Mail_Id" class="col-lg-3 control-label" width="200px"></asp:Label></td>
        <td>
       ...
       <tr>
        <td>
            <asp:Label ID="Label3" runat="server" Text="Company Name" class="col-lg-3 control-label" width="200px"></asp:Label></td>
        <td>
