<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Expenses_Report.aspx.cs" Inherits="Admin_Day_wise_purchase" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <hr />
 <br />  <div class="col-md-2"><h3> From Date:</h3>
   ...
   <div class="col-md-5" style="color: #993300"><h2>Total Expenses : </h2></div>
  <div class="col-md-6" style="color: #993300; font-family: Century"><asp:TextBox ID="TextBox1" runat="server" style="font-size:30px" 
           ></asp:TextBox></div></div>
     </ContentTemplate>
       <Triggers>
...
<div class="col-md-12">
   ...
   <ContentTemplate>
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="4" ShowFooter="True" 
         Font-Size="16px" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Expenses No" DataField="id"  >
 ...
 <br /> <asp:Button ID="Button1" runat="server" CssClass="btn2" Text="Export to excel" onclick="Button1_Click" 
        ></asp:Button>
</div>
