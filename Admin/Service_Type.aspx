<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Service_Type.aspx.cs" Inherits="Admin_Main" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="panel panel-default">
  <div class="panel-body">
  <br /><h2>Enter Service Type Here</h2><hr />
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
                               <div class="form-group"><label class="col-lg-3 control-label">Service Type  Id : </label>

                                    <div class="col-lg-9">
                                     <asp:UpdatePanel ID="UpdatePanel3" runat="server">
   <ContentTemplate>
                                    <asp:Label ID="Label1" runat="server" style="margin-left:10px" Text=""></asp:Label> 
                                      </ContentTemplate>
                                <Triggers>
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                 ...
                 <asp:AsyncPostBackTrigger ControlID="Button10" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button11" EventName="Click"  />
                                ...
                                <div ><label class="col-lg-3 control-label">Service Type : </label>
   ...
   <ContentTemplate>
                    ...
                    <br /><br />   <asp:Button ID="Button1" runat="server" class="btn-primary" Width="70px" Height="30px"  Text="Create" onclick="Button1_Click" 
                          ></asp:Button>&nbsp;
...
<div class="col-md-12">
   ...
   <ContentTemplate>
   <asp:GridView ID="GridView1" runat="server" class="red" Width="100%" CellPadding="3" 
         Font-Size="16px" 
       ...
       <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Service Type ID" DataField="category_id"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Service Type" DataField="categoryname" >
             <HeaderStyle CssClass="red" />
           </asp:BoundField>
          ...
          <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/edit4.jpg" Height="20px" Width="20px" onclick="ImageButton1_Click" headertext="Edit"   ></asp:ImageButton>
  ...
  <br /> <asp:Button ID="Button11" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox"  OnClientClick="return validate1()"  
      ...
      <asp:Button ID="Button8" runat="server" Text="Button" style="display:none" />
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" class="col-lg-3 control-label" Width="200px" Text="Type Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-3 control-label" Width="200px" Text="Service Type"></asp:Label></td>
        <td>
