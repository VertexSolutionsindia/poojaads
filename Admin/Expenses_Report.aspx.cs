...
public partial class Admin_Day_wise_purchase : System.Web.UI.Page
{
    ...
    public static List<string> SearchCustomers2(string prefixText, int count)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "select Serv_Name from Expenses where  Com_Id=@Com_Id and  " +
    ...
    protected void TextBox3_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from Expenses where Timefrom='" + TextBox3.Text + "' and Com_Id='" + company_id + "' ORDER BY id asc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
    ...
    protected void TextBox2_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand CMD = new SqlCommand("select * from Expenses where Timefrom between  '" + TextBox3.Text + "' and '" + TextBox2.Text + "' and  Com_Id='" + company_id + "' ORDER BY id asc", con);
        DataTable dt1 = new DataTable();
        SqlDataAdapter da1 = new SqlDataAdapter(CMD);
        da1.Fill(dt1);
        GridView1.DataSource = dt1;
