<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Service_name.aspx.cs" Inherits="Admin_Service_name" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="col-md-12">
   ...
   <div class="col-md-2"><h3>Service Type:</h3>
   ...
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Service Name Id</label>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="3" 
       ...
       <Columns>
        <asp:TemplateField HeaderText="Select">
           ...
           <asp:BoundField HeaderText="Service Name Id" DataField="servicename_id"  >
            <HeaderStyle CssClass="Grd1" />
           <ItemStyle CssClass="Grd1" />
           </asp:BoundField>
   ...
   <ContentTemplate>
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" class="col-lg-3 control-label" Width="200px" Text="Service Name Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td >
            <asp:Label ID="Label2" runat="server" class="col-lg-3 control-label" Width="200px"  Text="Service Type Name"></asp:Label></td>
        <td>
