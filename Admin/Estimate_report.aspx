<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Estimate_report.aspx.cs" Inherits="Admin_Estimate_report" %>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" class="red" Width="100%" 
      ...
      <Columns>
       ...
       <asp:BoundField HeaderText="Client Name" DataField="client_name" ItemStyle-Width="100px" >
