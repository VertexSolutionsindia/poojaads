<%@ Page Language="C#" AutoEventWireup="true" CodeFile="email_report.aspx.cs" Inherits="Admin_email_report" %>
...
<html lang="en">
    <head>
        ...
        <link href="css/style.css" type="text/css" rel="stylesheet">
           <link href="css1/email_reportcss.css" type="text/css" rel="stylesheet">
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                           <div class="page-title see2">
                                <h2>E-Mail Details  <small></small></h2>
  ...
  <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" 
      ...
      <Columns>
          <asp:BoundField HeaderText="Email_add" DataField="Email_add" />
         ...
         <PagerStyle    BorderStyle="Solid" Width="100%" 
           ...
           HorizontalAlign="Center"  />
               ...
               <asp:Button ID="Button33" runat="server" Text="Button" style="display:none" />
                    ...
                    <h3 style="font-size:20px; "> View email</h3><span style="float:right; margin-top:-30px;"> <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/delete3.png" Width="20px" Height="20px"></asp:ImageButton></span>
                     </div>
