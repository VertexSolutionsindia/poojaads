<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stock-Clearance.aspx.cs" Inherits="Admin_Stock_Clearance" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <div class="panel-body">
   <div class="col-md-12">
                             ...
                             <br /> <div class="form-group"><label class="col-lg-3 col-lg-offset-2 control-label" style="color: #666666; font-family: Century; font-size: large;">Pending Stock In day  : </label>
...
<asp:GridView ID="GridView1" runat="server" Width="653px"></asp:GridView>
