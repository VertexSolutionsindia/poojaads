...
<div class="panel-body">
   ...
   <div class="col-md-6">
                        ...
                        <div class="form-group"><label class="col-lg-3 control-label">Barcode No</label>

                                    <div class="col-lg-9">
                                     <asp:UpdatePanel ID="UpdatePanel9" runat="server">
   <ContentTemplate>
  <asp:TextBox ID="TextBox6" runat="server" class="form-control input-x2 dropbox"  AutoPostBack="true" ontextchanged="TextBox6_TextChanged"
                                        ></asp:TextBox>
                                        <%--<asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="TextBox5" WatermarkText="Enter Barcode No" ></asp:TextBoxWatermarkExtender>--%>
                                <asp:AutoCompleteExtender ID="AutoCompleteExtender4" runat="server" MinimumPrefixLength="1" ServiceMethod="SearchBarcode" FirstRowSelected = "false" CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" TargetControlID="TextBox6"  CompletionListCssClass="completionList"
     CompletionListItemCssClass="listItem"
     CompletionListHighlightedItemCssClass="itemHighlighted">
      </asp:AutoCompleteExtender>
                                      </ContentTemplate>
...
<div class="container">
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" CellPadding="4" 
       ...
       <Columns>
               ...
               <asp:BoundField HeaderText="Purchase Invoice" DataField="purchase_invoice" SortExpression="purchase_invoice" />
