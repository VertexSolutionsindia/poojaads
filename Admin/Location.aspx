<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Location.aspx.cs" Inherits="Admin_Sub_category" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
 ...
 <hr /> 
   <div class="row">
   <div class="col-md-2 col-md-offset-1"><h3>Services:</h3>
  ...
  <div class="panel panel-default">
  <div class="panel-body">
  <br /><h2>Enter Location Details Here</h2>
  <hr />
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-3 control-label">Location Id : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="TextBox3" EventName="TextChanged"  />
                                     ...
                                     <div class="col-lg-3 ad"><br /><a href="Service_Type.aspx">New Service</a></div>
                                </div>
 ...
 <asp:UpdatePanel ID="UpdatePanel8" runat="server">
   <ContentTemplate>
                       <asp:TextBox ID="TextBox1" runat="server" CssClass="serachbx" width="100%" 
                                    ontextchanged="TextBox1_TextChanged" AutoPostBack="true"></asp:TextBox>

                           <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server"  TargetControlID="TextBox1" WatermarkText="Search Location"></asp:TextBoxWatermarkExtender>
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <Columns>
        <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Location Id" DataField="subcategory_id"  >
            <HeaderStyle CssClass="red" />
           </asp:BoundField>
            <asp:BoundField HeaderText="Service Type" DataField="category_name"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Location" DataField="subcategoryname" >
            <HeaderStyle CssClass="red" />
           </asp:BoundField>
            <asp:TemplateField>
          <ItemTemplate>
  ...
  <br />  <asp:Button ID="Button14" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox" OnClientClick="return validate1()" onclick="Button14_Click"/>
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
         ...
         <div style="padding:12px; border:1px solid #e5e5e5;   border-radius:10px; background-color:#E6E6FA;color:#233445; font-size:15px; font-weight:400px; font-family: 'Open Sans',"HelveticaNeue", "Helvetica Neue", Helvetica, Arial,sans-serif; ">
                     <h3 style="font-size:20px; " class="control-label"> Update Location  <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/exit11.png" width="30px" height="30px" style="float:right" /></h3>
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" class="col-lg-3 control-label" Width="200px" Text="Location Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td >
            <asp:Label ID="Label2" runat="server" class="col-lg-3 control-label" Width="200px"  Text="Service Type"></asp:Label></td>
        <td>
            <asp:DropDownList ID="DropDownList4" class="form-control input-x2 dropbox" runat="server"></asp:DropDownList></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label30" runat="server" class="col-lg-3 control-label" Width="200px" Text="Location"></asp:Label></td>
        <td>
