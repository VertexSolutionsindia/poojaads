...
#endregion
public partial class Admin_Order_bill_pay_amount : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        string return_by = "";
        int value1 = 0;
        string status1 = "Collected amount";
        ...
        SqlCommand cmd22 = new SqlCommand("update pay_amount_status set Buyer=@Buyer,address=@address,total_amount=@total_amount,pending_amount=@pending_amount,paid_amount=@paid_amount,Com_Id=@Com_Id where Buyer='" + TextBox3.Text + "' and year='" + Label1.Text + "' ", con22);
