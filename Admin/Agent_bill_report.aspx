<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Agent_bill_report.aspx.cs" Inherits="Admin_Agent_bill_report" %>
 ...
 <asp:GridView ID="GridView1" runat="server" class="red" Width="100%" 
      ...
      <Columns>
       <asp:TemplateField ItemStyle-Width="10px" HeaderStyle-CssClass="10PX">
         ...
         <asp:BoundField HeaderText="Bill No" DataField="bill_no"  ItemStyle-Width="50px">
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
           <asp:BoundField HeaderText="Bill Date" DataField="bill_date" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="50px">
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
       <asp:BoundField HeaderText="Agent Name" DataField="agent_name" ItemStyle-Width="100px" >
        
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
        
   
         <asp:BoundField HeaderText="Agent Address" DataField="agent_add"  ItemStyle-Width="200px" >
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
          <asp:BoundField HeaderText="From date" DataField="fromdate"  ItemStyle-Width="200px" DataFormatString="{0:dd/MM/yyyy}" >
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
          <asp:BoundField HeaderText="To date" DataField="todate"  ItemStyle-Width="200px" DataFormatString="{0:dd/MM/yyyy}" >
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
          <asp:BoundField HeaderText="Service Type" DataField="service_type" ItemStyle-Width="50px" >
          <HeaderStyle CssClass="red" />
          </asp:BoundField>
         <asp:BoundField HeaderText="Service Name" DataField="service_name"  ItemStyle-Width="100px">
            <HeaderStyle CssClass="red" />
          </asp:BoundField>
            <asp:BoundField HeaderText="Amount" DataField="bill_amount" ItemStyle-Width="50px" >
              <HeaderStyle CssClass="red" />
          </asp:BoundField>
