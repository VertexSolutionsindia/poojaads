...
public partial class Admin_Order_bill_payment_outstanding : System.Web.UI.Page
{
    ...
    {
        SqlConnection con1 = new SqlConnection(ConfigurationManager.AppSettings["connection"]);
        SqlCommand cmd1 = new SqlCommand("Select * from Client_Entry where  Com_Id='" + company_id + "' ORDER BY Client_Code asc", con1);
        con1.Open();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("Order_bill_pay_amount.aspx");
