   ...
   <ContentTemplate>
    <asp:TextBox ID="TextBox2" runat="server" class="form-control input-x2 dropbox"  
           AutoPostBack="true" ontextchanged="TextBox2_TextChanged"
                        ...
                        <div class="container">
                        <div class="row">
                         <div class="col-sm-5 col-sm-offset-1" style="color: #993300">
                           <asp:UpdatePanel ID="UpdatePanel3" runat="server">
   <ContentTemplate>
 <h2>Total Credit : </h2><asp:TextBox ID="TextBox1" runat="server" style="font-size:30px" 
           ></asp:TextBox>
     </ContentTemplate>
       <Triggers>
    <asp:AsyncPostBackTrigger ControlID="TextBox3" EventName="TextChanged"  />
                 <asp:AsyncPostBackTrigger ControlID="TextBox2" EventName="TextChanged"  />
                                                 ...
                                                 <div class="col-sm-6" style="color: #990000">
                           <asp:UpdatePanel ID="UpdatePanel7" runat="server">
   <ContentTemplate>
 <h2>Total Debit : </h2><asp:TextBox ID="TextBox4" runat="server" style="font-size:30px" 
           ></asp:TextBox>
     </ContentTemplate>
       <Triggers>
    <asp:AsyncPostBackTrigger ControlID="TextBox3" EventName="TextChanged"  />
...
<div class="col-md-6" style="overflow: scroll" >
   ...
   <ContentTemplate>
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="200%" CellPadding="3" ShowFooter="True" 
         Font-Size="16px" 
       ...
       <Columns>
           ...
           <asp:BoundField HeaderText="Service Id" DataField="id"  >
           ...
           <asp:BoundField HeaderText="From" DataField="Timefrom"  
             ...
             <asp:BoundField HeaderText="Particulers" DataField="Serv_Name"  >
              <HeaderStyle CssClass="red" />
           </asp:BoundField>
 ...
 <ContentTemplate>
 <asp:GridView ID="GridView2" runat="server" CssClass="red" Width="200%" CellPadding="3" ShowFooter="True" 
         Font-Size="16px" 
           AutoGenerateColumns="False" AllowPaging="True" 
        onpageindexchanging="GridView2_PageIndexChanging" 
        onrowdatabound="GridView2_RowDataBound" PageSize="20" BackColor="White" 
           BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
       <Columns>
       
         
           <asp:BoundField HeaderText="Expenses Id" DataField="id"  >
        ...
        <asp:TemplateField HeaderText="Debit">
                    <ItemTemplate>
                        <asp:Label ID="lblSalary" runat="server" Text='<%# Eval("payment_clctd")%>' DataFormatString="{0:N2}" />
                    </ItemTemplate>
                    <FooterTemplate>
                        <asp:Label ID="Salary" runat="server" />
                    </FooterTemplate>
