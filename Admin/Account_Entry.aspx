<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_Entry.aspx.cs" Inherits="Admin_Cutomer_type" %>
            ...
            <div class="container-fluid">
                ...
                <div class="search" style="display: none;">
                  ...
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></a>
                </div>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <br /><h2>Enter Account Details Here</h2><hr />
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-4 control-label">Account Id : </label>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                 ...
                 <asp:AsyncPostBackTrigger ControlID="Button10" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button11" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-4 control-label">Account NickName : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                                                            ...
                                                                                            <div class="form-group"><label class="col-lg-4 control-label">Bank : </label>
 ...
 <asp:Button ID="Button2" runat="server" class="btn-primary2" Width="70px" Height="30px"  Text="Clear" onclick="Button2_Click" 
  ...
  <div class="col-md-12">
   <div class="row">
    <div class="col-md-1 col-md-offset-0" ><h2>Filters</h2>
 </div></div>
 <hr />
  <div class="row">
  <div class="col-sm-6">
   <div class="col-md-4"><h3>Account Nick Name:</h3></div>

    
   <div class="col-sm-7"><asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" 
           data-style="btn-primary1" data-width="100%" AutoPostBack="true" 
           Height="10px" onselectedindexchanged="DropDownList2_SelectedIndexChanged" ></asp:DropDownList></div>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
        ...
        onrowdatabound="GridView1_RowDataBound" PageSize="10" BackColor="White" BorderColor="#CCCCCC" 
       ...
       <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Account ID" DataField="Account_id"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Account Nick Name" DataField="Acc_nickname" >
            <HeaderStyle CssClass="red" />
           </asp:BoundField>
            <asp:BoundField HeaderText="Acoount Name" DataField="Acc_name"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Bank" DataField="Banck" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Account No" DataField="Acc_No" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
 ...
 <br />  <asp:Button ID="Button11" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox"  OnClientClick="return validate1()"  
      ...
      <asp:Button ID="Button8" runat="server" Text="Button" style="display:none" />
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" class="col-lg-4 control-label" Text="Account Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" class="col-lg-4 control-label" Text="Account Nick Name"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox11" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
         <tr>
        <td>
            <asp:Label ID="Label2" runat="server" class="col-lg-4 control-label" Text="Account Name"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox6" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
           <tr>
        <td>
            <asp:Label ID="Label3" runat="server" class="col-lg-4 control-label" Text="Account Bank"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox7" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
            <tr>
        <td>
            <asp:Label ID="Label4" runat="server" class="col-lg-4 control-label" Text="Account No"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox8" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
             <tr>
        <td>
            <asp:Label ID="Label5" runat="server" class="col-lg-4 control-label" Text="IFSC CODE"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox9" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
        <tr>
        <td></td>
        <td>
