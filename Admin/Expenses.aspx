<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Expenses.aspx.cs" Inherits="Admin_Tax_Entry" %>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <br /><h2>Enter expenses details here</h2><hr />
   <div class="col-md-6">
                 <div class="panel-body">
                           <div class="form-horizontal">
                               <br />
                               <div class="form-group"><label class="col-lg-4 control-label">Expenses Id : </label>
  ...
  Enabled="True" Format="dd/MM/yyyy" TargetControlID="TextBox1">
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="form-group"><label class="col-lg-4 control-label">Expenses Name : </label>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                                 ...
                                                                 <div class="form-group"><label class="col-lg-4 control-label">Price : </label>
...
<div class="col-md-2 col-md-offset-1"><h3>Particular : </h3></div>

    
  <div class="col-md-5"> <asp:DropDownList ID="DropDownList2" runat="server"  CssClass="selectpicker" 
           data-style="btn-primary1" data-width="100%" AutoPostBack="true" Height="10px" onselectedindexchanged="DropDownList2_SelectedIndexChanged" ></asp:DropDownList>
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Expenses Name" DataField="Serv_Name" >
             <HeaderStyle CssClass="red" />
           </asp:BoundField>
             <asp:BoundField HeaderText="Date" DataField="Timefrom"  >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Price" DataField="payment_clctd" >
             <HeaderStyle CssClass="red" />
           </asp:BoundField>
             <asp:TemplateField>
          <ItemTemplate>
   ...
   <ContentTemplate>    
    <br /><asp:Button ID="Button11" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox"  OnClientClick="return validate1()"  
      ...
      <asp:Button ID="Button8" runat="server" Text="Button" style="display:none" />
        ...
        <tr>
        <td>
            <asp:Label ID="Label15" runat="server" CssClass="labelstyle" Text="Expenses Id"></asp:Label></td>
        <td>
            <asp:Label ID="Label16" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label17" runat="server" CssClass="labelstyle" Text="Expenses"></asp:Label></td>
        <td>
        ...
        <tr>
        <td>
            <asp:Label ID="Label2" runat="server" CssClass="labelstyle" Text="Date"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox4" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label3" runat="server" CssClass="labelstyle" Text="Price"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox5" runat="server" CssClass="paneltext0"></asp:TextBox></td>
        </tr>
        <tr>
        <td>
