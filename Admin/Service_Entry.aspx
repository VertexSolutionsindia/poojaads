<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Service_Entry.aspx.cs" Inherits="Admin_Product_entry" %>
...
<html lang="en">
    <head id="Head1" runat="server">
        ...
        <title>Pooja Advertisement</title>
...
<asp:Button ID="Button4" runat="server"  Text="ADD" class="btn btn-primary"></asp:Button> <span aria-hidden="true" class="glyphicon glyphicon-plus"></span> </a>
  ...
  <br /><h2>Enter Service Details here</h2>
  <hr />
   <div class="col-md-6">
                 <div class="panel-body">
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                ...
                                <div class="col-lg-3 ad"><br /><a href="Location.aspx">New Location</a></div>
   ...
   <ContentTemplate>
                ...
                <asp:AsyncPostBackTrigger ControlID="Button1" EventName="Click"  />
                  <asp:AsyncPostBackTrigger ControlID="Button2" EventName="Click"  />
                                                           ...
                                                           <div class="form-group"><label class="col-lg-3 control-label">Service Price : </label>
 ...
 <div class="col-sm-5">
   ...
   <div class="col-md-4"><h3>Service Type :</h3></div><div class="col-sm-8">
   ...
   <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control"  data-width="100%" AutoPostBack="true"  onselectedindexchanged="DropDownList2_SelectedIndexChanged"  ></asp:DropDownList>
     ...
     <div class="col-md-3"><h3>Location : </h3></div><div class="col-sm-8">
...
<div class="col-md-12">
   ...
   <asp:GridView ID="GridView1" runat="server" CssClass="red" Width="100%" CellPadding="3" 
       ...
       <asp:TemplateField>
           ...
           <asp:BoundField HeaderText="Service Type" DataField="category_name" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Location" DataField="subcategory_name" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:BoundField HeaderText="Service Name" DataField="product_name" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
            <asp:BoundField HeaderText="Service_Price" DataField="product_price" >
           <HeaderStyle CssClass="red" />
           </asp:BoundField>
           <asp:TemplateField>
          <ItemTemplate>
  ...
  <br />  <asp:Button ID="Button14" runat="server" Text="Delete Seleted Rows" CssClass="buttonbox" OnClientClick="return validate1()" onclick="Button14_Click"/>
    ...
    <asp:Panel ID="Panel2" runat="server" class="panel1" BorderColor="Black" BorderStyle="Solid" BackColor="White" Direction="LeftToRight" style="display:none;" 
        ...
        <tr>
        <td>
            <asp:Label ID="Label28" runat="server" Text="Code" class="col-lg-4 control-label"></asp:Label></td>
        <td>
            <asp:Label ID="Label29" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
        <td><asp:Label ID="Label2" runat="server" Text="Service Type" class="col-lg-4 control-label"></asp:Label></td>
        <td>
           <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
        <asp:DropDownList ID="DropDownList4" class="form-control input-x2 dropbox" AutoPostBack="true" runat="server" onselectedindexchanged="DropDownList4_SelectedIndexChanged"></asp:DropDownList>
        ...
        <tr> 
       <%-- <td><asp:Label ID="Label3" runat="server" Text="Location" class="col-lg-4 control-label"></asp:Label></td>
        <td><asp:DropDownList ID="DropDownList6" class="form-control input-x2 dropbox" AutoPostBack="true"  runat="server" onselectedindexchanged="DropDownList6_SelectedIndexChanged"></asp:DropDownList></td>--%>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label30" runat="server" Text="Service Name" class="col-lg-4 control-label" Width="200px"></asp:Label></td>
        <td>
            <asp:TextBox ID="TextBox16" runat="server"  class="form-control input-x2 dropbox"></asp:TextBox></td>
        </tr>
        <tr>
        <td>
            <asp:Label ID="Label4" runat="server" Text="Service Price" class="col-lg-4 control-label" Width="200px"></asp:Label></td>
        <td>
