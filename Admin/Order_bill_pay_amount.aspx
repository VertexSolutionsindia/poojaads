<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Order_bill_pay_amount.aspx.cs" Inherits="Admin_Order_bill_pay_amount" %>
      ...
      <Columns>
       ...
       <asp:BoundField HeaderText="Customer" DataField="Buyer"  >
        ...
        <asp:BoundField HeaderText="Date" DataField="Pay_date" 
         ...
         <asp:BoundField HeaderText="bill amount" DataField="Estimate_value"  >
          <HeaderStyle CssClass="Grd1" />
          <ItemStyle CssClass="Grd1" />
          </asp:BoundField>
